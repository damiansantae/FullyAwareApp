...
public class ListForgottenPresenter extends GenericPresenter
    <ListForgotten.PresenterToView, ListForgotten.PresenterToModel, ListForgotten.ModelToPresenter, ListForgottenModel>
    implements ListForgotten.ViewToPresenter, ListForgotten.ModelToPresenter, ListForgotten.ListForgottenTo, ListForgotten.ToListForgotten {
   ...
   */
  @Override
  public void onCreate(ListForgotten.PresenterToView view) {
    super.onCreate(ListForgottenModel.class, this);
    setView(view);
   ...
   */
  @Override
  public void onResume(ListForgotten.PresenterToView view) {
    setView(view);
